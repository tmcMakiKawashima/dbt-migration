...
from .schedules_items.engineering.public.schedule_mavis_req_json_tbl import schedule_mavis_req_json_tbl
...
from .schedules_items.marketing.public.schedule_stg_sinsya_jucyu import schedule_stg_sinsya_jucyu
from .schedules_items.marketing.public.schedule_stg_sinsya_jucyu_tuiko_hinban import schedule_stg_sinsya_jucyu_tuiko_hinban
""" supplydemand """
...
""" vinhis spec """
from .schedules_items.vinhis.spec.schedule_dm_vinhis_spec200_allsalecar import schedule_dm_vinhis_spec200_allsalecar
...
# mavis_req_json_tbl
schedules.append(schedule_mavis_req_json_tbl)
...
# AI21 新車受注
schedules.append(schedule_stg_sinsya_jucyu)
# AI21 新車受注追工品番
schedules.append(schedule_stg_sinsya_jucyu_tuiko_hinban)
""" supplydemand """
# 需給情報基盤_0130
...
""" vinhis spec """
# VIN X SPEC
schedules.append(schedule_dm_vinhis_spec200_allsalecar)
# VIN装備
