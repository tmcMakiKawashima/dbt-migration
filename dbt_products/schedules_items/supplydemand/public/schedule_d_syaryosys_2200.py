...
# 車両システム_2200
schedule_d_syaryosys_2200 = build_schedule_from_dbt_selection(
    [dbt_products_assets],
    job_name="job_build_d_syaryosys_2200",
    schedule_name="SYARYOSYS_2200",
    cron_schedule="00 22 * * 1-5",
    execution_timezone="Asia/Tokyo",
    dbt_select="+stg_vlt_syaryosys +stg_oem_syaryosys +stg_cmf_syaryosys",
    config=RunConfig(ops={"dbt_products_assets":
                          DbtConfig(dbt_vars={"DBT_JOB_NAME": "_d_syaryosys_2200"},
