...
# T-LINX_EPC 品番検索TYPE2 ハイブリッドテーブルテスト ctas 中間テーブル作成
schedule_stg_t_linx_epc_ctas_ht_tbl_test = build_schedule_from_dbt_selection(
    [dbt_products_assets],
    job_name="stg_t_linx_epc_ctas_ht_tbl_test",
    ...
    tags={"ecs/cpu": "256", "ecs/memory": "1024",
          "job_name": "job_build_stg_t_linx_epc_ctas_ht_tbl_test"},
)
