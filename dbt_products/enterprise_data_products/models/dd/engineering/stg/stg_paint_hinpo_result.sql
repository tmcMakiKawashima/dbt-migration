with
  ...
  stg_accept_test as (
    select
      ...
      created_at, -- 登録日
      updated_at -- 変更日
    from {{ref('stg_accept_test')}}
  ),
  stg_hinpo_result as (
    select
      quality_result_id, -- 品保検査結果ID
      accept_test_id, -- 受入検査ID
      test_date, -- 検査日
      l25, -- L25
      a25, -- a25
 ...
 select
   ...
   stg_hinpo_result.test_date,  -- 検査日
   stg_hinpo_result.l25,  -- L25
   stg_hinpo_result.a25,  -- a25
   stg_hinpo_result.b25,  -- b25
   stg_hinpo_result.dl25,  -- dL25
   stg_hinpo_result.da25,  -- da25
   stg_hinpo_result.db25,  -- db25
   stg_hinpo_result.de25,  -- dE25
   stg_hinpo_result.l45,  -- L45
   stg_hinpo_result.a45,  -- a45
   stg_hinpo_result.b45,  -- b45
   stg_hinpo_result.dl45,  -- dL45
   stg_hinpo_result.da45,  -- da45
   stg_hinpo_result.db45,  -- db45
   stg_hinpo_result.de45,  -- dE45
   stg_hinpo_result.l75,  -- L75
   stg_hinpo_result.a75,  -- a75
   stg_hinpo_result.b75,  -- b75
   stg_hinpo_result.dl75,  -- dL75
   stg_hinpo_result.da75,  -- da75
   stg_hinpo_result.db75,  -- db75
   stg_hinpo_result.de75,  -- dE75
   stg_hinpo_result.comments,  -- コメント
   stg_hinpo_result.remark,  -- 備考
   stg_hinpo_result.created_at as quality_result_created_at  -- 検査結果登録日
 from stg_material
  ...
  left outer join stg_hinpo_result
    on stg_accept_test.accept_test_id = stg_hinpo_result.accept_test_id