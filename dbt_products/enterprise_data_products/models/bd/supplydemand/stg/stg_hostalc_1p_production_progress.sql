...
with stg_hostalc_1p_production_progress as (
  ...
  from {{ ref('substr_hostalc_1p_dkae06047201') }}
)
select * from stg_hostalc_1p_production_progress
where ldts = (select max(ldts) from stg_hostalc_1p_production_progress)