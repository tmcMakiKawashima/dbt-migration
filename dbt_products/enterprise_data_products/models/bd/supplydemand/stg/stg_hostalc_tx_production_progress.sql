...
with stg_hostalc_tx_production_progress as (
  select
...
select * from stg_hostalc_tx_production_progress
where ldts = (select max(ldts) from stg_hostalc_tx_production_progress)