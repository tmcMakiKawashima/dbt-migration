with substr_ktrla038zz0kadcb8e as (
    select
        ...
        substr(raw_data, 8, 8)::varchar(8) as lineoff_beto_ymd,
        substr(raw_data, 16, 7)::varchar(7) as funcdtl_cd,
        ...
        ldts,
        line_number
    from {{source('snowpipe_db_supplydemand','raw_ktrla038zz0kadcb8e')}}
)
select * from substr_ktrla038zz0kadcb8e