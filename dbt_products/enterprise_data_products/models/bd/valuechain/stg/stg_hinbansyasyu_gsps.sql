with stg_hinbansyasyu_gsps as (
    select
        trim(hinban, ' 　')::varchar(15) as hinban, -- 左右ブランク
    ...
    from {{ source('fivetran_database_idr_gsps_dxpfy2d', 'raw_cvk02hinsyasyu') }}
    where _fivetran_deleted = 'false'
)

select * from stg_hinbansyasyu_gsps