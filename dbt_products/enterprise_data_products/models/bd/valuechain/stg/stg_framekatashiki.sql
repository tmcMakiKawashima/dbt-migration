...
with stg_framekatashiki as (
    select
        ...
        rtrim(frmnokata, ' 　')::varchar(7) as frmnokata, 
        rtrim(replace(frmno, '@', '0'), ' 　')::varchar(7) as frmno, 
        rtrim(mdlyearkbn, ' 　')::varchar(1) as mdlyearkbn, 
        rtrim(vin, ' 　')::varchar(17) as vin, 
        ...
        rtrim(syakata, ' 　')::varchar(20) as syakata, 
