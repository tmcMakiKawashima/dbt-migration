with stg_hokyusetteisyoku_smshokyu as (
    select
        ...
        trim(kangoflg,' 　')::varchar(1) as kangoflg, -- 左右ブランク
    ...
    from {{source('fivetran_database_idr_hokyu_sms_dxpfy2d', 'raw_cvf03hosetuclr')}}
    where _fivetran_deleted = 'false'
)

select * from stg_hokyusetteisyoku_smshokyu