{{ config(
      ...
      unique_key = ['langkbn', 'ctlgcd', 'hinmeicd', 'syasyu_cd', 'hinban', 'kosu', 'jissijikik', 'jissijikim', 'siyoptno', 'epckataptno', 'kiricdk', 'kiricdm', 'trmcdmlt', 'clrcdmlt', 'tkstkbn', 'hktkgaikbn', 'hosemhin'],
      incremental_strategy = 'merge'
   ) }}

with stg_hinbankensakutype2_merge_ht_test as (
    select
    ...
    from {{ ref('substr_cv201khintype2_merge_ht_test') }}
)
select * exclude(mntkbn, line_number, aggkey)
from stg_hinbankensakutype2_merge_ht_test
