with stg_disp_name_mst_iqas as (
    select
        table_id::varchar(100) as table_id,
    ...
    from {{ source('fivetran_database_oraclerds_orcl_iqas_osepcs0000db20', 'raw_cep3301disp_name_mst') }}
    where _fivetran_deleted = 'false'    )
select *
from stg_disp_name_mst_iqas