{{
    config (
        post_hook=
            'create or replace hybrid table vinhis_db.model.dm_vin_model (
                 ...
                 constraint dm_vin_model_frmnokata_frmno_syasyu_cd_syakata_langkbn_uk primary key (frmnokata, frmno, syasyu_cd, syakata, langkbn) rely 
            ) as select * from {{this}}'
    )
}}
...
inner join syaryoshiyosobijoho
 ...
 and tmp20.siyoptno = syaryoshiyosobijoho.siyoptno
