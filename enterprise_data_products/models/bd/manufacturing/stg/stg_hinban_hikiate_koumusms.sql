{{ config(
       ...
       unique_key = ['jigyoutaicd', 'kouku', 'renban', 'syasyu', 'siyoubui', 'oyahin', 'gc', 'kohin', 'ruibetu', 'kanrikt', 'ktkigo', 'jikt01', 'jikt02', 'jikt03', 'jikt04', 'jikt05', 'jikt06', 'jikt07', 'jikt08', 'jikt09', 'oyakt', 'tck', 'naigaikbn', 'tehaishogokey', 'idline', 'unitkbn', 'nisugata', 'oderkbn', 'shimukecd', 'shimukekouku', 'multisspkbn', 'blkcd'],
...
with stg_hinban_hikiate_koumusms as (
    select
        ...
        jikt10::varchar(6) as jikt10, --自工程工程符号１０
        jikt11::varchar(6) as jikt11, --自工程工程符号１１
        jikt12::varchar(6) as jikt12, --自工程工程符号１２
        jikt13::varchar(6) as jikt13, --自工程工程符号１３
        jikt14::varchar(6) as jikt14, --自工程工程符号１４
        ...
        rank() over(partition by 
            ...
            multisspkbn,
            blkcd
        order by ldts desc, _fivetran_id desc) aggkey
