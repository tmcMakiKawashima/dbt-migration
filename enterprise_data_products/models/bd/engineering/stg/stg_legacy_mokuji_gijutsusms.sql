...
with
    stg_legacy_mokuji_gijutsusms as (
        select
            ...
            row_number() over (
                partition by jigyoutai, syasyu32, syasyu, kumitate, bui, kata, torokujunk, sakuseikbn, sekkei, sochaku, hikisiyo, vari
                order by _fivetran_synced desc, mttime desc, torokujunm desc
            ) as aggkey
