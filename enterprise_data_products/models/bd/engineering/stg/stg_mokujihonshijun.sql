{{ config(
      ...
      unique_key = ['jigyoutai','syasyu_cd','torokujun'],
...
with
    stg_mokujihonshijun as (
        ...
        from {{ source('fivetran_database_idr_gijutsu_sms_dxpfy2d', 'raw_cyp05junkanri') }}
        where
...
select * from stg_mokujihonshijun
