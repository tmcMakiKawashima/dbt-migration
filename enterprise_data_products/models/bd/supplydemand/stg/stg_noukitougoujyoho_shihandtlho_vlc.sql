    ...
    config (
        ...
        post_hook="
            {% if is_incremental() %}
                ...
                from {{ source('fivetran_database_ogg_vlc_osubsp0200db20', 'raw_cubd004shihandtlho') }}
...
with stg_noukitougoujyoho_shihandtlho_vlc as (
    select
...
select * from stg_noukitougoujyoho_shihandtlho_vlc
