with stg_hostalc_0g_production_progress as (
    select
    ...
    from {{ ref('substr_hostalc_0g_dkae06047201') }}
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_0g_dkae06047201') }})
)
select * from stg_hostalc_0g_production_progress