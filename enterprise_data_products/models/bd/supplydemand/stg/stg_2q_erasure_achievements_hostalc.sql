with stg_2q_erasure_achievements_hostalc as (
    select
    ...
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_2q_dkae06046602') }})
)
select * from stg_2q_erasure_achievements_hostalc