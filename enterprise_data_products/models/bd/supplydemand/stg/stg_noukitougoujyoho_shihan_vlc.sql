    ...
    config (
        ...
        post_hook="
            {% if is_incremental() %}
                ...
                from {{ source('fivetran_database_ogg_vlc_osubsp0200db20', 'raw_cubd001shihan') }}
...
with stg_noukitougoujyoho_shihan_vlc as (
    select
...
select * from stg_noukitougoujyoho_shihan_vlc
