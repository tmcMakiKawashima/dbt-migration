with stg_3a_production_progress_hostalc as (
    select
    ...
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_3a_dkae06047201') }})
)
select * from stg_3a_production_progress_hostalc