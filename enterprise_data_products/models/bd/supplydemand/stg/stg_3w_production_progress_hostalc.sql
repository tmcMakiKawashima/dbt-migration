with stg_3w_production_progress_hostalc as (
    select
    ...
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_3w_dkae06047201') }})
)
select * from stg_3w_production_progress_hostalc