with stg_hostalc_7c_vehicle_specification as (
    select
    ...
    from {{ ref('substr_hostalc_7c_dkae02072402') }}
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_7c_dkae02072402') }})
)
select * from stg_hostalc_7c_vehicle_specification