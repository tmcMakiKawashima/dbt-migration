with stg_3w_virtual_line_hostalc as (
    select
        ...
        ldts -- b層のldts
    from {{ ref('substr_hostalc_3w_dkae02072301') }}
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_3w_dkae02072301') }})
)
select * from stg_3w_virtual_line_hostalc