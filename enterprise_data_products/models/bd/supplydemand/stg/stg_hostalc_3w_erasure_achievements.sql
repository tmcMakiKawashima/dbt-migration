...
with stg_hostalc_3w_erasure_achievements as (
  select
...
select * from stg_hostalc_3w_erasure_achievements
where ldts = (select max(ldts) from stg_hostalc_3w_erasure_achievements)