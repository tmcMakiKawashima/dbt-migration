with stg_2u_virtual_line_hostalc as (
    select
        ...
        ldts -- b層のldts
    from {{ ref('substr_hostalc_2u_dkae02072301') }}
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_2u_dkae02072301') }})
)
select * from stg_2u_virtual_line_hostalc