with stg_3a_virtual_line_hostalc as (
    select
        ...
        ldts -- b層のldts
    from {{ ref('substr_hostalc_3a_dkae02072301') }}
    where ldts = (select max(ldts) from {{ ref('substr_hostalc_3a_dkae02072301') }})
)
select * from stg_3a_virtual_line_hostalc