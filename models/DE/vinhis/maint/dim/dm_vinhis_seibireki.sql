...
select
    ...
    tmp10_dm_vinhis_seibireki.meisaino as nyuko_detail_no, -- 明細行番号
    tmp10_dm_vinhis_seibireki.seibicd as seibi_cd, -- 整備コード
    stg_seibimeisyomaster.seibi_name as seibi_cd_name -- 整備コード名称
from tmp10_dm_vinhis_seibireki
left outer join stg_seibimeisyomaster on tmp10_dm_vinhis_seibireki.seibicd = stg_seibimeisyomaster.seibi_cd
