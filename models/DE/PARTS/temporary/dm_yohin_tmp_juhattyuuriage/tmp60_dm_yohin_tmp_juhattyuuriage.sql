...
select
    ...
    , atopjuchu.JHINBAN as check_JHINBAN --nullチェック用
    , hinban.PNO as check_PNO --nullチェック用
    , tasshimuke.KYOUHAN as check4_KYOUHAN --nullチェック用
    , atopshimuke.DLRCD as check_DLRCD --nullチェック用
from temp50
