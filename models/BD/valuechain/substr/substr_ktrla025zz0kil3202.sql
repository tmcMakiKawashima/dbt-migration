with substr_ktrla025zz0kil3202 as (
    select
        ...
        substr(raw_data, 5, 20)::varchar(20) as carno,
        substr(raw_data, 25, 8)::varchar(8) as sttldy,
        substr(raw_data, 33, 5)::varchar(5) as dlrcd,
        substr(raw_data, 38, 8)::varchar(8) as ordrno,
