with substr_ktrla025zz0kil3205 as (
    select
        ...
        substr(raw_data, 15, 8)::varchar(8) as sainyukoymd,
        substr(raw_data, 23, 1)::varchar(1) as tyoushiukagaikekkacd,
        ...
        substr(raw_data, 40, 1)::varchar(1) as huguaisaigenumu,
        substr(raw_data, 41, 50)::varchar(50) as geninmeisyo,
        ldts
