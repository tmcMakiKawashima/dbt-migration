...
# os.getenv("layer_sample01")で環境変数を取得しアセットキーとしてreturnしている
class CustomeizedDagsterDbtTranslator(DagsterDbtTranslator):
    def get_asset_key(self, dbt_resource_props: Mapping[str, Any]) -> AssetKey:
        return super().get_asset_key(dbt_resource_props).with_prefix(os.getenv("layer_sample01"))
...
@asset(
    ...
    key_prefix=[os.getenv("layer_sample01"), os.getenv("dbt_resource_edp")])
